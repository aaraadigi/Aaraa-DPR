...
import { Check, Clock, AlertCircle, Truck, CreditCard, ShieldCheck, FileText, Send } from 'lucide-react';
...
export const IndentStatusTracker: React.FC<IndentStatusTrackerProps> = ({ status }) => {
  const steps = [
    ...
    { id: '3', label: 'QS Check', match: ['QS_Analysis', 'Procurement_Quoting', 'Ops_Approval', 'MD_Final_Approval', 'Finance_Payment_Pending', 'Procurement_Dispatch', 'GRN_Pending', 'Completed'] },
    ...
    { id: '6', label: 'MD Sign', match: ['MD_Final_Approval', 'Finance_Payment_Pending', 'Procurement_Dispatch', 'GRN_Pending', 'Completed'] },
    ...
    { id: '9', label: 'Site GRN', match: ['GRN_Pending', 'Completed'] },
  ...
  return (
    <div className="w-full py-6 px-2 overflow-x-auto no-scrollbar">
      <div className="relative flex justify-between min-w-[600px] px-4">
        {/* Line Background */}
            ...
            <div key={step.id} className="relative z-10 flex flex-col items-center group">
              <div className={`
                ...
                ${stepStatus === 'complete' ? 'bg-green-500 border-green-500 text-white' : 
                  stepStatus === 'active' ? 'bg-white border-blue-500 text-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.3)] animate-pulse' : 
              ...
              <span className={`
                absolute -bottom-6 text-[8px] font-bold uppercase tracking-tight whitespace-nowrap
